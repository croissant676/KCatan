...
class GameView(
    ...
    private val listOfTiles by lazy {
        listOf(
            tile0,
            tile1,
            tile2,
    ...
    private val listOfCircles by lazy {
        listOf(
            circle0,
            circle1,
            circle2,
    ...
    private val listOfLabels by lazy {
        listOf(
            label0,
            label1,
            label2,
    ...
    override fun onDock() {
        listOfTiles.withEach {
            ...
            logger.info { "Tile $tile with style $styleName" }
            addClass(styleName)
...
class TileFragment(val tile: Tile) : Fragment("Tile") {
    companion object : KLogging()
